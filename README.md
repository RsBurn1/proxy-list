...
# [SAMPLE PROXIES] - [April 01 2023 | 11:50:08]
...
- _Proxies (Total):_
   - **Online Proxies (SOCKS4/5 + HTTP/S)** -> 6000
   - **Unique Online Proxies** -> 6000
   - **Unique Online/Offline Proxies (Archive)** -> 40555

## [SOCKS4 (2385/6000)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-socks4.txt)
```yaml
1.2.187.111:4145
1.4.195.114:4145
1.4.214.148:5678
...
## [SOCKS5 (477/6000)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-socks5.txt)
```yaml
3.89.57.89:8088
3.89.137.9:8088
3.237.253.189:8088
...
## [HTTP (2457/6000)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-http.txt)
```yaml
1.0.205.87:8080
1.1.220.71:8080
1.2.252.65:8080
...
## [HTTPS (2848/6000)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-https.txt)
```yaml
1.0.205.87:8080
1.1.220.71:8080
1.2.252.65:8080
...
## [ARCHIVE (6000/40555)](https://raw.githubusercontent.com/jetkai/proxy-list/main/archive/txt/proxies.txt)
```yaml
1.0.132.249:4153
1.0.133.89:4153
1.0.133.100:51327
