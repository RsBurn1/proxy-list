...
# [SAMPLE PROXIES] - [March 24 2023 | 09:50:08]
...
- _Proxies (Total):_
   - **Online Proxies (SOCKS4/5 + HTTP/S)** -> 6081
   - **Unique Online Proxies** -> 6081
   - **Unique Online/Offline Proxies (Archive)** -> 38039

## [SOCKS4 (2705/6081)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-socks4.txt)
```yaml
1.0.208.111:4145
1.2.187.111:4145
1.4.163.25:4145
...
## [SOCKS5 (544/6081)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-socks5.txt)
```yaml
1.180.49.222:7302
3.83.234.151:8088
5.11.17.230:1080
...
## [HTTP (2259/6081)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-http.txt)
```yaml
1.1.220.63:8080
1.1.220.71:8080
1.1.220.72:8080
...
## [HTTPS (2615/6081)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-https.txt)
```yaml
1.1.220.63:8080
1.1.220.71:8080
1.1.220.72:8080
...
## [ARCHIVE (6081/38039)](https://raw.githubusercontent.com/jetkai/proxy-list/main/archive/txt/proxies.txt)
```yaml
1.0.132.249:4153
1.0.133.89:4153
1.0.133.100:51327
