...
- _Proxies (Total):_
   - **Online Proxies (SOCKS4/5 + HTTP/S)** -> 5503
   - **Unique Online Proxies** -> 5503
   - **Unique Online/Offline Proxies (Archive)** -> 30085

## [SOCKS4 (2483/5503)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-socks4.txt)
```yaml
1.0.136.49:4145
1.2.180.233:4145
1.2.214.69:4145
...
## [SOCKS5 (535/5503)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-socks5.txt)
```yaml
1.179.220.211:59166
1.180.0.162:7302
3.80.219.118:8088
...
## [HTTP (2243/5503)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-http.txt)
```yaml
1.1.220.63:8080
1.1.220.71:8080
1.2.218.69:4145
...
## [HTTPS (2446/5503)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-https.txt)
```yaml
1.0.171.213:8080
1.1.220.63:8080
1.1.220.71:8080
...
## [ARCHIVE (5503/30085)](https://raw.githubusercontent.com/jetkai/proxy-list/main/archive/txt/proxies.txt)
```yaml
1.0.132.249:4153
1.0.133.89:4153
1.0.133.100:51327
