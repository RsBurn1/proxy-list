...
# [SAMPLE PROXIES] - [March 11 2023 | 08:50:08]
...
- _Proxies (Total):_
   - **Online Proxies (SOCKS4/5 + HTTP/S)** -> 5993
   - **Unique Online Proxies** -> 5993
   - **Unique Online/Offline Proxies (Archive)** -> 32715

## [SOCKS4 (2344/5993)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-socks4.txt)
```yaml
1.1.214.159:4145
1.2.180.233:4145
1.4.195.114:4145
...
## [SOCKS5 (561/5993)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-socks5.txt)
```yaml
1.180.0.162:7302
1.180.49.222:7302
3.83.166.222:8088
...
## [HTTP (2780/5993)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-http.txt)
```yaml
1.0.205.87:8080
1.1.189.58:8080
1.1.220.71:8080
...
## [HTTPS (2951/5993)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-https.txt)
```yaml
1.0.171.213:8080
1.0.205.87:8080
1.1.189.58:8080
...
## [ARCHIVE (5993/32715)](https://raw.githubusercontent.com/jetkai/proxy-list/main/archive/txt/proxies.txt)
```yaml
1.0.132.249:4153
1.0.133.89:4153
1.0.133.100:51327
