...
# [SAMPLE PROXIES] - [March 21 2023 | 06:50:07]
...
- _Proxies (Total):_
   - **Online Proxies (SOCKS4/5 + HTTP/S)** -> 4804
   - **Unique Online Proxies** -> 4804
   - **Unique Online/Offline Proxies (Archive)** -> 36434

## [SOCKS4 (2069/4804)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-socks4.txt)
```yaml
1.1.201.119:4145
1.2.187.111:4145
1.4.163.25:4145
...
## [SOCKS5 (468/4804)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-socks5.txt)
```yaml
1.12.55.136:2080
1.180.49.222:7302
3.83.141.49:8088
...
## [HTTP (1825/4804)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-http.txt)
```yaml
1.0.205.87:8080
1.1.220.63:8080
1.1.220.72:8080
...
## [HTTPS (2185/4804)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-https.txt)
```yaml
1.0.171.213:8080
1.0.205.87:8080
1.1.220.63:8080
...
## [ARCHIVE (4804/36434)](https://raw.githubusercontent.com/jetkai/proxy-list/main/archive/txt/proxies.txt)
```yaml
1.0.132.249:4153
1.0.133.89:4153
1.0.133.100:51327
