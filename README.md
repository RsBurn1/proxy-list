...
- _Proxies (Total):_
   - **Online Proxies (SOCKS4/5 + HTTP/S)** -> 5096
   - **Unique Online Proxies** -> 5096
   - **Unique Online/Offline Proxies (Archive)** -> 34499

## [SOCKS4 (2575/5096)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-socks4.txt)
```yaml
1.0.161.232:4145
1.2.187.54:4145
1.4.214.148:5678
...
## [SOCKS5 (548/5096)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-socks5.txt)
```yaml
1.15.236.43:7890
1.179.220.211:59166
1.180.49.222:7302
...
## [HTTP (1812/5096)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-http.txt)
```yaml
1.1.220.63:8080
1.1.220.71:8080
1.1.220.72:8080
...
## [HTTPS (1959/5096)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-https.txt)
```yaml
1.0.171.213:8080
1.1.220.63:8080
1.1.220.71:8080
...
## [ARCHIVE (5096/34499)](https://raw.githubusercontent.com/jetkai/proxy-list/main/archive/txt/proxies.txt)
```yaml
1.0.132.249:4153
1.0.133.89:4153
1.0.133.100:51327
