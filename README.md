...
# [SAMPLE PROXIES] - [March 21 2023 | 01:50:08]
...
- _Proxies (Total):_
   - **Online Proxies (SOCKS4/5 + HTTP/S)** -> 6234
   - **Unique Online Proxies** -> 6234
   - **Unique Online/Offline Proxies (Archive)** -> 36292

## [SOCKS4 (2840/6234)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-socks4.txt)
```yaml
1.1.201.119:4145
1.1.228.236:4145
1.2.187.111:4145
...
## [SOCKS5 (567/6234)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-socks5.txt)
```yaml
1.12.55.136:2080
1.180.0.162:7302
1.180.49.222:7302
...
## [HTTP (2293/6234)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-http.txt)
```yaml
1.1.220.63:8080
1.1.220.71:8080
1.2.252.65:8080
...
## [HTTPS (2737/6234)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-https.txt)
```yaml
1.0.171.213:8080
1.1.220.63:8080
1.1.220.71:8080
...
## [ARCHIVE (6234/36292)](https://raw.githubusercontent.com/jetkai/proxy-list/main/archive/txt/proxies.txt)
```yaml
1.0.132.249:4153
1.0.133.89:4153
1.0.133.100:51327
